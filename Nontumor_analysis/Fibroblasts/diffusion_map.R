# Author: Somnath Tagore, Ph.D. Title: Integrated Fibroblasts diffusion
# Script Name: diffusion_map.R 
...
# Read in file
patient <- readRDS('./Diffusion_Component_Analysis/Fibroblasts/scrnaseq_all_upd.rds')
...
pdf('Fibroblasts_res_0.1_refined_upd.pdf')
...
pdf('Fibroblasts_res_0.1_refined_upd_2Dversion.pdf')
