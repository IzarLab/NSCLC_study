...
sigs_excel = "Epithelial_lung_signature_BI_ST.xlsx"
...
covid_sigs
"""
laughney_sigs_df = pd.read_excel(sigs_excel, sheet_name='Developmental signatures').T
laughney_sigs = {}
...
epi_sigs_df = pd.read_excel(sigs_excel, sheet_name='CellAssign_signatures long ').T
epi_sigs = {}
...
all_genes =set(create_marker_gene_matrix(covid_sigs).index)
...
integrated_adata_filt.write("filtered_cellassign_adata_ST.h5ad")



sigs_excel = "Epithelial_lung_signature_BI.xlsx"
...
integrated_adata_filt.write("filtered_cellassign_adata_BI.h5ad")